  ...
  const defaultMessage = [
    {
      sender: "You",
      time: "19:32",
      textMsg: "No worries. It will be completed ASAP. I’ve asked him yesterday.",
      dateMsg: "Yesterday June 08, 2021",
      newMsg: false,
    },
    {
      sender: "Mary Hilda",
      time: "19:32",
      textMsg: "Hello Obaidullah, I will be your case advisor for case #029290. I have assigned some homework for you to fill. Please keep up with the due dates. Should you have any questions, you can message me anytime. Thanks.",
      dateMsg: "Today June 09, 2021",
      newMsg: false,
    },

    {
      sender: "You",
      time: "19:32",
      textMsg: "Please contact Mary for questions regarding the case bcs she will be managing your forms from now on! Thanks Mary.",
      dateMsg: "Today June 09, 2021",
      newMsg: false,
    },
    {
    ...
    },
    {
      ...
      time: "19:32",
      textMsg: "Morning. I’ll try to do them. Thanks",
      dateMsg: "Today June 09, 2021",
      newMsg: true,
    },
  ]
  return (
    <>
      ...
      <div className=" overflow-y-auto sm:max-h-[247px] 2xl:max-h-[377px] 1920:max-h-[594px]">
        {/* message */}
        {defaultMessage.map((dflt, index) => (
          <div key={index} className={`flex ${dflt.sender === "You" ? "send_by_me flex flex-col items-end" : "send_by_other flex flex-col gap-y-2"}`}>
            <span>{dflt.sender}</span>
              ...
              {dflt.sender === "You" ? (
                <>
                  ...
                  <div className="1920:max-w-[432px] bg-[#EEDCFF] text-[12px] flex flex-col p-[10px] rounded-[5px] gap-y-1">
                    <p className="leading-3">{dflt.textMsg}</p>
                    <p>{dflt.time}</p>
                  </div>
                </>
              ) : (
                <>
                  <div className={`1920:max-w-[518px] ${dflt.newMsg ? "bg-[#D2F2EA]" : "bg-[#FCEED3]"} text-[12px] flex flex-col p-[10px] rounded-[5px] gap-y-1`}>
                    <p>{dflt.textMsg}</p>
                    <p>{dflt.time}</p>
                  </div>
                  <div className="w-4 h-4 items-center mt-[10px]">
